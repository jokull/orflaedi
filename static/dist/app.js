...
})({"heryc":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "dfd5faebf5bd83b5";
module.bundle.HMR_BUNDLE_ID = "fc9a53a3f9e13d01";
...
},{}],"8DHyV":[function(require,module,exports) {
...
document.querySelectorAll(".picker .inner").forEach(function(pickerEl) {
    var buttonEl = pickerEl.querySelector(".title");
    buttonEl.addEventListener("click", function(event) {
        pickerEl.classList.toggle("expanded");
    });
});
document.querySelectorAll(".tags a").forEach(function(el) {
    var _dataset = el.dataset, id = _dataset.id, tag = _dataset.tag;
    var tagged = el.classList.contains("tagged");
            ...
            return _regeneratorRuntimeDefault.default.wrap(function _callee$(_ctx) {
                while(1)switch(_ctx.prev = _ctx.next){
                    case 0:
                        ...
                        _ctx.next = 3;
                        return fetch("/models/".concat(id, "/tags/").concat(tag), {
...
},{"@swc/helpers":"4hG4D","regenerator-runtime":"gwp18","lazysizes":"6TCWq","@parcel/transformer-js/src/esmodule-helpers.js":"5ITdS"}],"4hG4D":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"6TCWq":[function(require,module,exports) {
...
},{}]},["heryc","8DHyV"], "8DHyV", "parcelRequire3e22")
